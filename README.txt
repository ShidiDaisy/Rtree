...
To complete the read file and output file:

Step 1: copy the Rtree points in the folder ‘ass1’, rename it as ‘dataset’.
...
Note: there are sample files with the required format already.
